...
private let logger = Logger(subsystem: "com.surahfocus.api", category: "AlQuranAPIDataSource")
...
final class AlQuranAPIDataSourceImpl: AlQuranAPIDataSource {
    ...
    func fetchSurahTransliteration(surahNo: Int) async throws -> [Int: String] {
        ...
        let map = Dictionary(uniqueKeysWithValues: response.data.ayahs.map { ($0.numberInSurah, $0.text) })
