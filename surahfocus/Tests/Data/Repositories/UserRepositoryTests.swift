...
final class UserRepositoryTests: XCTestCase {
    ...
    func testUpdateStreak_SameDayActivity() async throws {
        ...
        XCTAssertEqual(finalUser?.currentStreak, streakBefore, "Streak should not increment on same day")
    }
    ...
    func testUpdateStreak_LongestStreakUpdated() async throws {
        ...
        XCTAssertEqual(finalUser?.longestStreak, 4, "Longest streak should be updated when exceeded")
    }
