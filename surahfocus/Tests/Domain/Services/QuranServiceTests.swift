...
final class QuranServiceTests: XCTestCase {
    ...
    func testSearchSurahsByName() {
        let surahs = [
            Surah(number: 1, name: "Al-Fatihah", englishName: "The Opening", englishNameTranslation: "The Opening", numberOfAyahs: 7, revelationPlace: "Mecca"),
            Surah(number: 2, name: "Al-Baqarah", englishName: "The Cow", englishNameTranslation: "The Cow", numberOfAyahs: 286, revelationPlace: "Medina"),
            Surah(number: 114, name: "An-Nas", englishName: "Mankind", englishNameTranslation: "Mankind", numberOfAyahs: 6, revelationPlace: "Mecca")
        ]
    ...
    func testErrorMessageForInvalidSurahNumber() async {
        do {
            ...
            XCTAssertEqual(error.errorDescription, "Invalid surah number. Please enter a number between 1 and 114.")
        } catch {
            XCTFail("Wrong error type: \(error)")
        }
    }
