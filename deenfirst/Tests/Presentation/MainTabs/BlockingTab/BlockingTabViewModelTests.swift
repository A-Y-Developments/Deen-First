...
final class BlockingTabViewModelTests: XCTestCase {
    ...
    func testBlockedAppsCount_ReturnsCorrectCount() {
        viewModel.appLimits = [
            AppLimit(
                userId: UUID(), name: "Limit1", appTokens: [], dailyLimitMinutes: 60,
                activeDays: [], isAllDay: false),
            AppLimit(
                userId: UUID(), name: "Limit2", appTokens: [], dailyLimitMinutes: 60,
                activeDays: [], isAllDay: false),
        ]
        viewModel.timeLimits = [
            TimeLimitSettings(
                userId: UUID(), name: "Limit3", appTokens: [], startTime: "09:00", endTime: "17:00",
                activeDays: [], isAllDay: false, prayerTimes: [])
        ]
...
class MockTimeLimitServiceForBlockingTab: TimeLimitService {
    ...
    func createTimeLimit(
        userId: UUID, name: String, appTokens: [Data], startTime: String, endTime: String,
        activeDays: [Int], isAllDay: Bool, prayerTimes: [String]
    ) async throws {
    }
