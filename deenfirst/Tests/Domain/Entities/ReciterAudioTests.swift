...
final class ReciterAudioTests: XCTestCase {
    ...
    func testAllFiveReciters() {
        let reciters = [
            ReciterAudio(
                reciterId: 1, reciterName: "Mishary Rashid Al Afasy", url: "url1",
                originalUrl: "orig1"),
            ReciterAudio(
                reciterId: 2, reciterName: "Abu Bakr Al Shatri", url: "url2", originalUrl: "orig2"),
            ReciterAudio(
                reciterId: 3, reciterName: "Nasser Al Qatami", url: "url3", originalUrl: "orig3"),
            ReciterAudio(
                reciterId: 4, reciterName: "Yasser Al Dosari", url: "url4", originalUrl: "orig4"),
            ReciterAudio(
                reciterId: 5, reciterName: "Hani Ar Rifai", url: "url5", originalUrl: "orig5"),
        ]
