...
final class DateExtensionTests: XCTestCase {
    ...
    func testIsSameDay_SameDayDifferentTimesReturnsTrue() {
        ...
        let date2 = calendar.date(
            from: DateComponents(year: 2025, month: 1, day: 15, hour: 22, minute: 30, second: 45))!
    ...
    func testIsSameDay_OneSecondApartReturnsFalse() {
        let calendar = Calendar.current
        let date1 = calendar.date(
            from: DateComponents(year: 2025, month: 1, day: 15, hour: 23, minute: 59, second: 59))!
        let date2 = calendar.date(
            from: DateComponents(year: 2025, month: 1, day: 16, hour: 0, minute: 0, second: 0))!
    ...
    func testStartOfDay_ReturnsMidnight() {
        ...
        let date = calendar.date(
            from: DateComponents(year: 2025, month: 1, day: 15, hour: 14, minute: 30, second: 45))!
