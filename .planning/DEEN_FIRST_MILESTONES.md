# DEEN FIRST - DEVELOPMENT MILESTONES
...
**Reference:** `DEEN_FIRST_PRD.md` Section 3.3
...
- [ ] Update `Project.swift` to include extensions (see `DEEN_FIRST_SYSTEM_DESIGN.md` Section 11.5.2)
- [ ] Create entitlements:
  - `DeenFirst/DeenFirst.entitlements`:
    ```xml
...
- Extensions have correct bundle IDs:
  - `com.aydev.deenfirst.ScreenTimeMonitor`
  - `com.aydev.deenfirst.Shield`
...
**Reference:** `DEEN_FIRST_UI_UX_DESIGN.md` Section 1
...
**Reference:** `DEEN_FIRST_PRD.md` Section 1.4

**Tasks:**
- [ ] Initialize RevenueCat in `DeenFirstApp.swift`:
  ```swift
  import RevenueCat
...
**Reference:** `DEEN_FIRST_UI_UX_DESIGN.md` Section 2
...
**Reference:** `DEEN_FIRST_PRD.md` Section 4.1
...
**Reference:** `DEEN_FIRST_UI_UX_DESIGN.md` Section 7
...
**Reference:** `DEEN_FIRST_SYSTEM_DESIGN.md` Section 2.3
...
xcodebuild test -scheme DeenFirst -only-testing:DeenFirstTests/AuthServiceTests

# Generate coverage report
xcodebuild test -scheme DeenFirst -enableCodeCoverage YES
```
