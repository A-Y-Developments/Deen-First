...
func requestPermission() async {
    do {
        ...
        // Permission denied
        showAlert("Screen Time permission is required for Surah Focus to work. You can enable it in Settings.")
    }
}
```
...
- Contact Support → mailto: support@surahfocus.com
...
- Product ID: `com.aydev.surahfocus.monthly` ($4.99, 3-day trial)
- Product ID: `com.aydev.surahfocus.yearly` ($29.99, 7-day trial)
...
**Description**:
```
Surah Focus helps you overcome phone addiction by combining Quran reading with screen time management.
...
SUBSCRIPTION INFO:
Surah Focus requires a subscription to access all features.
